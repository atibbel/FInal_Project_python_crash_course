...
monthly statements."""
  ...
  def print_all_statements(self, statement_list):
    # Print all statements (and statement details) associated with this account by looping through their statements array
    transaction_count = 0
    pass
